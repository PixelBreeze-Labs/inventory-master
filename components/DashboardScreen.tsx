...
// import CalendarExportView from "../home/components/CalendarExportView";
// import AttendanceOverview from "../home/components/AttendanceOverview";
// import TaskReportView from "../home/components/TaskReportView";
    ...
    <View style={styles.container}>
      ...
      <View style={styles.welcomeView}>
        <View style={styles.leftSideView}>
          ...
          <Text style={styles.subTitle}>Welcome to Sales Assocaite App</Text>
        </View>
      ...
      {/* Options View */}
      <TouchableOpacity style={styles.card} onPress={() => router.push("/attendance")}>
      ...
      {/* Time Tracking */}
      <TouchableOpacity style={styles.card} onPress={() => router.push("/timeTracking")}>
        <View style={styles.iconContainer}>
          <Image
            style={styles.cardItemIcon}
            // @ts-ignore
      ...
      {/* My Accounts */}
      <TouchableOpacity style={styles.card} onPress={() => router.push("/account")}>
        <View style={styles.iconContainer}>
          <Image
            style={styles.cardItemIcon}
            // @ts-ignore
