...
const ProductFilterModal = ({ isVisible, setModal }: Props) => {
            ...
            <View style={styles.customerTypeContainer}>
              {
                sizesList.map((item, index) => (
                    <TouchableOpacity
                        key={index}
                        style={[styles.customerTypeButton, customerType === item.value && styles.selectedType]}
                        onPress={() => setCustomerType(item.value)}>
                        <Text style={[styles.customerTypeText, customerType === item.value && {color: '#ffffff'}]}>{item.label}</Text>
                    </TouchableOpacity>
                ))
              }
            </View>
          ...
          <View style={styles.section}>
            ...
            <View style={styles.pickerContainer}>
              <RNPickerSelect
                    ...
                    items={data}
                    placeholder={{ label: "Select collection", value: "0" }}
                    style={{
